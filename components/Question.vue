        ...
        <div class="questions">
            <div class="question py-10 max-w-6xl m-0 m-auto pt-8">
                ...
                <div class="swipe-btns px-1 sm:px-2 mt-10  mb-10 pb-6 flex justify-center items-center  gap-1 xs:gap-4 sm:gap-8">
                        ...
                        <div :class="{ Neutral: Question.Status=='Neutral' }" @click="Neutral(Question)" class="next-btn cursor-pointer notSelected flex justify-center  items-center px-4 py-4">
                            <label  class="cursor-pointer">Passer</label>
                        </div>

                    

                        <div :class="{ Like: Question.Status=='Like' }" @click="Like(Question)" class="controll-btn notSelected cursor-pointer px-6 max-h-24 h-fit  sm:px-8 py-2  flex gap-2 justify-center items-center flex-wrap">
